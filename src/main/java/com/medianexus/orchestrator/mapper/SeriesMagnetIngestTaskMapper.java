...
@Mapper
public interface SeriesMagnetIngestTaskMapper extends BaseMapper<SeriesMagnetIngestTask> {

    @Update("""
            CREATE TABLE IF NOT EXISTS series_magnet_ingest_tasks (
                ...
                season_folder VARCHAR(255) NOT NULL,
    ...
    @Update("""
            ALTER TABLE series_magnet_ingest_tasks
            ADD COLUMN quality_tag VARCHAR(32) NULL AFTER season_number
            """)
