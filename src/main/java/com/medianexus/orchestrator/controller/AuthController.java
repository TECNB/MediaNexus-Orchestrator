...
public class AuthController {
    ...
    public ApiResponse<AuthSessionResponse> register(@RequestBody AuthRegisterRequest request) {
    ...
    @PostMapping("/logout")
    @Operation(summary = "登出", description = "清理当前 Bearer token 对应的登录状态；未登录时保持幂等成功。")
