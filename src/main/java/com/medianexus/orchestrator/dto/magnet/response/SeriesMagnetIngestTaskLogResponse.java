...
@Schema(description = "剧集 magnet 导入任务日志")
public record SeriesMagnetIngestTaskLogResponse(
        @Schema(description = "日志自增 id")
        Long id,
        @Schema(description = "所属导入任务 id")
        @JsonProperty("task_id")
        String taskId,
        @Schema(description = "日志级别：INFO、WARN 或 ERROR")
        String level,
        @Schema(description = "任务阶段，例如 created、submitted、downloading、organizing、succeeded、failed")
        String stage,
