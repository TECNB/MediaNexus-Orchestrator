...
public record JavdbPlaylistSyncRunResponse(
        ...
        @JsonProperty("rating_desired_count") int ratingDesiredCount,
        @JsonProperty("rating_updated_count") int ratingUpdatedCount,
        @JsonProperty("rating_existing_count") int ratingExistingCount,
        @JsonProperty("rating_waiting_count") int ratingWaitingCount,
        @JsonProperty("rating_failed_count") int ratingFailedCount,
